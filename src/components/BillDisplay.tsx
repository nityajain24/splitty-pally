...
import { Receipt, CircleDollarSign, PiggyBank } from 'lucide-react';
      ...
      <Card className="w-full">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="border rounded-md divide-y">
            <h3 className="p-3 text-sm font-medium bg-gray-50 dark:bg-gray-800">Items on your bill</h3>
            
            {state.items.map((item) => (
              <div key={item.id} className="p-3 flex justify-between hover:bg-gray-50 dark:hover:bg-gray-800">
                <span>{item.name}</span>
